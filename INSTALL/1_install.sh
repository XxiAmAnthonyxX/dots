...
yay -S kitty hyprland nvidia linux-headers qt5ct qt6ct libva libva-nvidia-driver-git xdg-desktop-portal xdg-desktop-portal-gtk xdg-desktop-portal-hyprland polkit-kde-agent qt5-wayland qt6-wayland sddm xwaylandvideobridge-git 
